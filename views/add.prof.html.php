<h2 class="a5"> <i class="fa-regular fa-folder-open fa-lg" style="color: #1c588a;"></i> AJOUTER UN PROFESSEUR</h2>
    <form action="<?webRoot?>" method="post" >
        <div class="addcontainer1">
            <div class="CONTENU">
                ...
                <BUtton class="btannuler1" name="action" value="return-liste-prof">Annuler</BUtton> <button class="btenregistrer1" name="action" value="form-add-prof" >Enregistrer</button>
            </div>
        </div>
