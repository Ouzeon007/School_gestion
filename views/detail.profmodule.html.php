...
<form action="<?webRoot?>" method="post" >
    ...
    <div >
        <h2 class="module1">Module</h2>
        <p class="modulecheck1"> <span><input type="checkbox" name="module-affect[]" value="UML" > <Label for="">UML</Label> </span>  <span><input type="checkbox" name="module-affect[]" value="PHP" > <Label for="">PHP</Label> </span>  <span><input type="checkbox" name="module-affect[]" value="JAVA" > <Label for="">JAVA</Label> </span> <span><input type="checkbox" name="module-affect[]" value="PYTHON" > <Label for="">PYTHON</Label> <span> </p>
        </div>
    
        <button class="b11" name="action" value="return-liste-prof">Annulez</button> <button class="b12" name="action" value="form-affecter-module" >Enregistrer</button>
     </div>
</form>
